...
const ZH_CN: Record<string, string> = {
  ...
  'Agents added to Mission Control': '多个 Agent 已加入任务控制台',
  'Agent removed': 'Agent 已移除',
  'Project updated': '项目已更新',
  'Project created': '项目已创建',
  'Project deleted': '项目已删除',
  'Category updated': '大类已更新',
  'Category created': '大类已创建',
  'Category deleted': '大类已删除',
  ...
  'Search categories, projects and agents': '搜索大类、项目和 Agent',
  'Project Explorer': '项目浏览器',
  'PROJECTS': '项目',
  'CATEGORIES': '大类',
  'New category': '新建大类',
  'Expand category': '展开大类',
  'Collapse category': '折叠大类',
  'New project in {{name}}': '在 {{name}} 中新建项目',
  ...
  'Edit Agent': '编辑 Agent',
  'Created': '创建时间',
  'Working folder': '运行文件夹',
  'First command': '第一条命令',
  'Latest command': '最近一条命令',
  'Last completed response': '最近完成任务的回复',
  'No recorded command': '暂无命令记录',
  'No completed response': '暂无已完成任务的回复',
  'Current status': '当前运行状态',
  'Focus and center {{name}}': '聚焦并居中显示 {{name}}',
  'MEMORY': '内存',
  'RUNNING TIME': '运行时间',
  'Not configured': '未配置',
  'TERMINAL OPEN': '终端已打开',
  ...
  'AI and regular terminal processes not yet assigned to a Project': '尚未分配到项目的 AI 与普通终端进程',
  'AI CLI processes not yet assigned to a Project': '尚未分配到项目的 AI CLI 进程',
  'Close': '关闭',
  'UNASSIGNED': '未分配',
  'SERVICES': '服务',
  'OTHER TERMINALS': '其他终端',
  'Filter discovered processes': '筛选已发现的进程',
  'Filter by name, path, command or keyword': '按名称、路径、命令或关键词筛选',
  'Select visible': '选择当前可见项',
  'Destination Project': '目标项目',
  'Add selected ({{count}})': '添加已选项（{{count}}）',
  'Select {{name}}': '选择 {{name}}',
  'MEM': '内存',
  'UP': '时长',
  ...
  'Keep it': '保留',
  'Deleting…': '正在删除…',
  'Review this action before removing the Agent.': '移除 Agent 前请确认此操作。',
  ...
  'Note': '备注',
  'No note': '暂无备注',
  'Used when this Codex session has no /goal objective. A live /goal objective takes priority automatically.': '当这个 Codex 会话没有 /goal 目标时使用；检测到实时 /goal 目标后会自动优先显示。',
  'A manual note shown on this Agent card.': '手动填写，并显示在这个 Agent 的卡片中。',
  'Symbol': '图标',
  'Type': '类型',
  'Color label': '标记颜色',
  ...
  'Category': '大类',
  'New Category': '新建大类',
  'A category keeps related Projects together in the sidebar.': '大类用于在侧边栏中归纳多个相关项目。',
  'Category name': '大类名称',
  'Move this category’s {{count}} Projects before deleting it.': '请先移动此大类中的 {{count}} 个项目，再删除大类。',
  'This removes the empty category from Agent Console.': '这会从 Agent Console 中移除这个空大类。',
  'Delete Category': '删除大类',
  'Save Category': '保存大类',
  ...
  'Discovered process window focused.': '已聚焦发现的进程窗口。',
  'This discovered process is no longer running.': '该发现进程已不再运行。',
  'The process is running, but its exact desktop window could not be focused.': '进程仍在运行，但无法聚焦其对应的准确桌面窗口。',
  ...
  'VS Code · Dark': 'VS Code · 深色',
  'A restrained workbench built from familiar editor charcoal, blue, and cool gray.': '以熟悉的编辑器炭黑、蓝色与冷灰色构成的克制工作台。',
  'VS Code Light': 'VS Code 浅色',
  'VS Code · Light': 'VS Code · 浅色',
  'A clean editor-white workspace with crisp dividers and the familiar VS Code blue.': '干净的编辑器白色空间，配以清晰分隔线和熟悉的 VS Code 蓝。',
  'Pure Monochrome': '纯黑白',
  'Black · White': '黑 · 白',
  'A strict black-and-white interface with hierarchy carried only by line, weight, and space.': '严格的黑白双色界面，仅以线条、字重与留白表达层级。',
}
